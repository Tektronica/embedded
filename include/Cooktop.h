...
// Off -> dim deep red -> bright orange, like a glowing burner element. Stays red/orange — never
// yellow or white (full saturation, hue capped at orange).
inline Hsv heatColor(uint8_t level) {
  ...
  return Hsv{h, 255, v};                                            // full saturation: red/orange, never white
}
